...
const ABOUT_APPLICATION_NAME = `${PRODUCT_DISPLAY_NAME} Desktop App`;
...
> = {
  "zh-CN": {
    ...
    copyright: (year) => `版权所有 © ${year} ${PRODUCT_DISPLAY_NAME}。`,
  },
  "en-US": {
    ...
    copyright: (year) => `Copyright © ${year} ${PRODUCT_DISPLAY_NAME}.`,
  },
};
