...
const PRODUCTION_IDENTITY = Object.freeze({
  ...
  appId: "dev.zcode.app",
  productName: "yuCode",
  linuxExecutableName: "yucode",
  linuxPackageName: "yucode",
...
const PREVIEW_IDENTITY = Object.freeze({
  ...
  productName: "yuCode Preview",
  linuxExecutableName: "yucode-preview",
  linuxPackageName: "yucode-preview",
 ...
 * - `ZCODE_ENV=test` 一律是 Preview，测试后端不能顶着正式 `yuCode` 身份覆盖用户的正式安装；
 ...
 * 生产后端的 Preview 包靠 productName（`yuCode Preview-<version>-...`）与正式包区分。
 */
