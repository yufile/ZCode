...
export const desktopMenuMessages: Record<Locale, DesktopMenuLocaleMessages> = {
  "zh-CN": {
    ...
    "titleBar.menu.help.about": `关于 ${PRODUCT_DISPLAY_NAME}`,
    ...
    "titleBar.menu.help.zcodeEndpoint": `${PRODUCT_DISPLAY_NAME} Endpoint`,
    ...
    "tray.menu.openZCode": `打开 ${PRODUCT_DISPLAY_NAME}`,
    "tray.menu.quit": "退出",
  },
  "en-US": {
    ...
    "titleBar.menu.help.about": `About ${PRODUCT_DISPLAY_NAME}`,
    ...
    "tray.tooltip": PRODUCT_DISPLAY_NAME,
    "tray.menu.openZCode": `Open ${PRODUCT_DISPLAY_NAME}`,
    "tray.menu.quit": "Quit",
  },
};
