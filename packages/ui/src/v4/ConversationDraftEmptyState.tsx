...
export function ConversationDraftEmptyState({ className }: { className?: string }) {
  ...
  return (
    ...
    >
      ...
      >
        <YuCodeEmptyStateLogo className="h-full w-full" />
      </div>
      <p
...
function YuCodeEmptyStateLogo({ className }: { className?: string }) {
  return (
    <img
      aria-hidden="true"
      className={cn(className, "object-contain opacity-20")}
      data-v4-draft-logo="yu-code"
      src={yuCodeLogoUrl}
      alt=""
    />
  );
